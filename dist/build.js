...
var _args$buildCommand = _cmdArgs2.default['build-command'],
    command = _args$buildCommand === undefined ? 'webpack' : _args$buildCommand,
    _args$_ = _cmdArgs2.default._,
    buildArgs = _args$_ === undefined ? [] : _args$_,
    src = _cmdArgs2.default['app-src'],
...
(0, _build2.default)({ command: command, args: buildArgs, src: src, pattern: pattern }).then(function () {
